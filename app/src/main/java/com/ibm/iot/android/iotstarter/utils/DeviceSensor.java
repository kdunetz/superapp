...
public class DeviceSensor implements SensorEventListener {
    ...
    public void enableSensor() {
        ...
        if (isEnabled == false) {
            ...
            timer = new Timer();
            timer.scheduleAtFixedRate(new SendTimerTask(), app.sensorTiming, app.sensorTiming);
            isEnabled = true;
        }
    }
    ...
    private class SendTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            String messageData = MessageFactory.getAccelMessage(G, O, yaw, lon, lat, app.getCurrentUser());
            String topic;
