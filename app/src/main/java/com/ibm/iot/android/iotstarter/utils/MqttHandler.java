    ...
    public void connect() {
        ...
        if (!isMqttConnected()) {
            ...
            if (app.getConnectionType() == Constants.ConnectionType.IOTF) {
                ...
                Log.e(TAG, "IN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HEREIN HERE");
   Log.e(TAG, app.getAuthToken());
    ...
    public void publish(String topic, String message, boolean retained, int qos) {
        ...
        if (isMqttConnected()) {
            ...
            Log.d(TAG, "Publish not connected");
            connectionLost(null);
        }
    }
    ...
    public void messageArrived(String topic, MqttMessage mqttMessage) throws Exception {
        Log.i(TAG, ".messageArrived() entered");
        ...
        Log.i(TAG, ".messageArrived - Message received on topic " + topic
                + ": message is " + payload);
