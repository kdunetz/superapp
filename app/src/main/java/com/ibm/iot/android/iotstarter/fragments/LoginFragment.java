...
public class LoginFragment extends IoTStarterFragment {
    ...
    protected void updateViewStrings() {
        ...
        if (app.getCurrentUser() != null) {
            ((EditText) getActivity().findViewById(R.id.usernameValue)).setText(app.getCurrentUser());
        }
    ...
    private boolean checkCanConnect() {
        Log.e("KEVIN", app.getOrganization());
        Log.e("KEVIN", app.getDeviceId());
        ...
        if (app.getCurrentUser() == null) return false;
        return true;
    }
    ...
    private void handleActivate() {
        ...
        {
            app.setDeviceId("iot-starter-android");
            app.setOrganization("3alh1w");
            app.setAuthToken("iot-starter-android");
        }

        String userName = ((EditText) getActivity().findViewById(R.id.usernameValue)).getText().toString();
        if (userName.length() == 0) {
            displaySetPropertiesDialog();
            return;
        }
        //KAD May 21, 2018 app.setCurrentUser(userName);
